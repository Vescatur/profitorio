...
local orders = {
    ...
    { band = 1, item = "burner-inserter",        amount = 1, profit = 0.25,
      cost = { penny = 2 }, refund = 2,
      spawn = { same = 80, up1 = 20 } },
    { band = 1, item = "assembling-machine-1",   amount = 1, profit = 0.25,
      cost = { penny = 5 }, refund = 5,
      spawn = { down1 = 30, same = 40, up1 = 30 } },
    { band = 1, item = "transport-belt",         amount = 2, profit = 0.25,
      cost = { penny = 3.5 }, refund = 3.5,
    ...
    { band = 2, item = "inserter",               amount = 1, profit = 0.25,
      cost = { penny = 6.5, silver_coin = 0.75 }, refund = 1.834,
      spawn = { same = 25, up1 = 50, up2 = 25 } },
    { band = 2, item = "splitter",               amount = 1, profit = 0.25,
      cost = { penny = 25.5, silver_coin = 3.75 }, refund = 8,
      spawn = { down1 = 25, same = 25, up1 = 50 } },
    { band = 2, item = "assembling-machine-2",   amount = 1, profit = 0.25,
      cost = { penny = 29, silver_coin = 3.25 }, refund = 8.084,
      spawn = { down2 = 25, down1 = 25, same = 25, up1 = 25 } },

    -- Banknote -- nothing here exists without coal and crude oil.
    { band = 3, item = "bulk-inserter",          amount = 1, profit = 0.25,
      cost = { penny = 97.5, silver_coin = 19, banknote = 0.928 }, refund = 5.963,
      spawn = { same = 25, up1 = 50, up2 = 25 } },
    { band = 3, item = "electric-furnace",       amount = 1, profit = 0.25,
      cost = { penny = 85, silver_coin = 22.5, banknote = 5.637 }, refund = 10.875,
      spawn = { down1 = 25, same = 25, up1 = 50 } },
    { band = 3, item = "productivity-module",    amount = 1, profit = 0.25,
      cost = { penny = 55, silver_coin = 27.25, banknote = 4.637 }, refund = 9.839,
      spawn = { down2 = 25, down1 = 25, same = 25, up1 = 25 } },

    -- Bond -- the robot era.
    { band = 4, item = "construction-robot",     amount = 1, profit = 0.25,
      cost = { penny = 32.4, silver_coin = 11.25, banknote = 6.382 }, refund = 1.753,
      spawn = { same = 25, up1 = 50, up2 = 25 } },
    { band = 4, item = "logistic-robot",         amount = 1, profit = 0.25,
      cost = { penny = 42.4, silver_coin = 18.75, banknote = 8.237 }, refund = 2.385,
      spawn = { down1 = 25, same = 25, up1 = 50 } },
    { band = 4, item = "roboport",               amount = 1, profit = 0.25,
      cost = { penny = 562.5, silver_coin = 202.5, banknote = 42.728 }, refund = 17.01,
      spawn = { down2 = 25, down1 = 25, same = 25, up1 = 25 } },

    -- Gold -- everything here pays a Bond toll of its own to be built at all.
    { band = 5, item = "express-transport-belt", amount = 1, profit = 0.25,
      cost = { penny = 31.75, silver_coin = 1, banknote = 1.6, bond = 1 }, refund = 0.3,
      spawn = { same = 25, up1 = 50, up2 = 25 } },
    { band = 5, item = "beacon",                 amount = 1, profit = 0.25,
      cost = { penny = 250, silver_coin = 107.5, banknote = 18.546, bond = 1 }, refund = 1.795,
      spawn = { down1 = 25, same = 25, up1 = 50 } },
    { band = 5, item = "productivity-module-2",  amount = 1, profit = 0.25,
      cost = { penny = 640.25, silver_coin = 252.75, banknote = 39.819 }, refund = 3.647,
      spawn = { down2 = 25, down1 = 25, same = 25, up1 = 25 } },
}
